:- module(db, [init/0, writePurchase/0, nextId/1, writeDrink/0, writePurchaseDrink/0, writeEmployee/0, writeCustomer/0, writeDrinkP/0, writeCandyP/0, writeService/0]).
...
init :- startPurchase, startId, startCandy, startPurchaseCandy, startDrink, startPurchaseDrink, startEmployee, startCustomer, startDrinkP, startCandyP, startService.